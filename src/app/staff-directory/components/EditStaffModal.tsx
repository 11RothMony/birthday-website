      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-card rounded-lg shadow-warm-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          <div className="sticky top-0 bg-card border-b border-border p-4 flex items-center justify-between">
            <h2 className="text-xl font-heading font-semibold text-foreground">Edit Staff Member</h2>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Cake Preference</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Gift Preference</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Party Preference</label>
              <input
                type="text"
