          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handlePreferenceChange("cakePreference", e.target.value)
                }
                className="w-full px-3 py-2 bg-background border border-input rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handlePreferenceChange("giftPreference", e.target.value)
                }
                className="w-full px-3 py-2 bg-background border border-input rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handlePreferenceChange("partyPreference", e.target.value)
                }
                className="w-full px-3 py-2 bg-background border border-input rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
              />
            </div>
